            ...
            <li class="padded paide">
               <table>
                  <tr>
                     ...
                     <td><?php echo $this->Form->control('first_name', ['label'=>false,'class'=>'validate[required] inputwid-2']); ?></td>
                  </tr>
                  <tr>
                     <td width="90"><label>Last Name*</label></td>
                     <td><?php echo $this->Form->control('last_name', ['label'=>false,'class'=>'validate[required] inputwid-2','label'=>false]); ?></td>
                  </tr>
                  <tr>
                     <td width="90"><label>Email*</label></td>
                     <td><?php echo $this->Form->control('email', ['label'=>false,'class' => 'validate[required,custom[email]] inputwid-1']); ?></td>
                  </tr>
                  <tr>
