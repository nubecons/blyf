  ...
  <div class="panel panel-default">
    <div class="panel-heading font-bold">
     <div class="row">
      ...
      <div class="col-sm-3">
      <a href="<?=$site_url?>admin/categories/add_sub"><button class="btn btn-default pull-right"> <i class="glyphicon glyphicon-plus"> </i> Add New</button></a>
      </div>
    </div>
    </div>
      ...
      <table class="table table-striped b-t b-light"  id="data_table">
		...
		foreach($Categories as $Category): 
         ?>
          ...
          <tr>
            <td><?php if(isset($MainCategories[$Category['parent_id']])){ echo $MainCategories[$Category['parent_id']] ;}?></td>
            ...
            <td>
             <a href="<?=$site_url?>admin/categories/edit_sub/<?=$Category['id']?>" title="Edit"><i class="fa fa-pencil"></i></a>
              &nbsp;&nbsp;
