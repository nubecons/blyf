...
<div class="wrapper-md col-sm-11" >
    ...
    <div class="panel panel-default">
     ...
     <div class="row">
      ...
      <a href="<?=$site_url?>admin/allergens"><button class="btn btn-default pull-right"> <i class="glyphicon glyphicon-list"></i> Go back to list</button></a>
      ...
      <?php echo $this->Form->create($Allergy, ["class" => "form-horizontal" , 'enctype' => 'multipart/form-data']); ?> 
           ...
           <label class="col-sm-2 control-label" for="input-id-1"></label>
              <div class="col-sm-5"><?php if($Allergy['image'] != ''){?>
                <img src="<?=$site_url?>img/Allergens/<?php echo $Allergy['image'];?>" alt="img" style="max-height:150px; max-width:150px"/>
               <?php }else{?>
